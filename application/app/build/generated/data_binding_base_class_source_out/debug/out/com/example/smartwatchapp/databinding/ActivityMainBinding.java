...
package com.example.smartwatchapp.databinding;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull TextView appName,
      @NonNull ImageView brokenHeart, @NonNull Button btnReadData, @NonNull Button btnUploadData,
      @NonNull ImageView heart, @NonNull TextView lastMeasuredLabel,
      @NonNull TextView lastMeasuredValue, @NonNull TextView notAvailable,
      @NonNull ProgressBar progress, @NonNull TextView statusText, @NonNull TextView timeNow) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, appName, brokenHeart, btnReadData,
          btnUploadData, heart, lastMeasuredLabel, lastMeasuredValue, notAvailable, progress,
          statusText, timeNow);
    }
